...
*NuPhy Halo65 V2 is a 65% wireless mechanical keyboard with Mac Globe dual-role key support.*

![NuPhy Halo65 V2](https://nuphy.com/products/halo65-v2)

* Keyboard Maintainer: [nuphy](https://github.com/nuphy-src)
* Hardware Supported: NuPhy Halo65 V2 PCB
* Hardware Availability: [NuPhy](https://nuphy.com/products/halo65-v2)
...
Make example for this keyboard (after setting up your build environment):
    ...
    make nuphy/halo65_v2/ansi:default

Flashing example for this keyboard:

    make nuphy/halo65_v2/ansi:default:flash

For VIA support:

    make nuphy/halo65_v2/ansi:via
